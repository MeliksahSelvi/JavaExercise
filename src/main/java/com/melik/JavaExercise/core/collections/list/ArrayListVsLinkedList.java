...
public class ArrayListVsLinkedList {
    ...
    public static void main(String[] args) {
        ...
        /*
         * The big-o notation of element remove is O(N).
         * Because we have to iterate all lists to delete action
         * */
        list.remove("1");
        ...
        /*
         * The big-o notation of element remove is O(N).
         * Because we have to iterate all linkedlist nodes to delete action
         * */
        linkedList.remove("1");
